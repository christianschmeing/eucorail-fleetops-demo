...
export const ECM_PROFILES = {
  FLIRT3: {
    IS1: { periodDays: 56, periodKm: 25000, durationHours: 5.0 },
    IS2: { periodDays: 150, periodKm: 75000, durationHours: 10.0 },
    IS3: { periodDays: 365, periodKm: 210000, durationHours: 20.0 },
    IS4: { periodDays: 913, periodKm: 540000, durationHours: 50.0 },
    IS5: { periodDays: 2190, periodKm: 1100000, durationHours: 160.0 },
    IS6: { periodDays: 2920, periodKm: 1300000, durationHours: 256.0 },
