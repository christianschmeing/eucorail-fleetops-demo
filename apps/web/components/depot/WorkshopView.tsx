              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <InspectionPit
                    pitNumber={1}
                    vehicle="78045"
                    inspection="Undercarriage"
                    progress={65}
                  />
                  <InspectionPit
                    pitNumber={2}
                    vehicle="66033"
                    inspection="Bogie Service"
                    progress={30}
                  />
                </div>
              </div>
...
function ServiceBay({
  ...
  return (
    <div
      className={`p-4 rounded-lg border-2 ${occupied ? 'border-blue-300 bg-blue-50' : 'border-gray-200 bg-white'}`}
    >
      ...
      {occupied ? (
        <div className="space-y-2">
          ...
          <div className="text-xs font-medium">
            {progress === 100 ? 'Complete' : `${Math.floor((100 - progress) * 0.6)} min remaining`}
          </div>
        </div>
      ) : (
