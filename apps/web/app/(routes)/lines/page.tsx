...
async function getLines(): Promise<Line[]> {
  try {
    ...
    // Fallback für SSR – Arverio BY/BW ohne S-Bahn (Quelle: fleet-allocation.json)
    return [
      // Baden-Württemberg
      {
        id: 'RE1',
      ...
      // Allgäu + Augsburger Netze (BY)
      {
        id: 'RE72',
        name: 'München – Buchloe – Memmingen',
        region: 'BY',
        operator: 'BRB',
        depot: 'Langweid',
        vehicles: 7,
      ...
      {
        id: 'RE96',
        name: 'München – Buchloe – Lindau-Reutin',
        region: 'BY',
        operator: 'BRB',
        depot: 'Langweid',
        vehicles: 9,
    ...
    <div className="h-full overflow-auto bg-gray-900">
      ...
      <div className="p-6">
                        ...
                        <div className="w-16 bg-gray-700 rounded-full h-2">
                          <div
                            className={`h-2 rounded-full ${
                              line.punctualityPct >= 90
                                ? 'bg-green-500'
                                : line.punctualityPct >= 80
                                  ? 'bg-yellow-500'
                                  : 'bg-red-500'
                            }`}
        ...
        <div className="mt-4 flex justify-between items-center text-sm text-gray-400">
          <div>
            Zeige {lines.length} von {lines.length} Linien • Summe Fahrzeuge:{' '}
